...
<body>
    <header>
        ...
        <a href="#basicInfo" id="icon"> <img src="img/iconColor1.png" alt="Info icon"> Basic Information</a>
        <!-- Basic Information / item b-->
        <a href="#summary" id="icon"><img src="img/iconColor2.png" alt="Summary icon"> Summary</a>
        <!-- Summary / item c-->
        <a href="#physical" id="icon"><img src="img/iconColor3.png" alt="Physical icon"> Physical</a>
        <!-- Physical / item d-->
        <a href="#chemical" id="icon"><img src="img/iconColor4.png" alt="Chemical icon"> Chemical</a>
        <!-- Chemical / item e-->
        <a href="#discovery" id="icon"><img src="img/iconColor5.png" alt="Discovery icon"> Discovery and Named</a>
        <!-- Discovery and Named / item f-->
        <a href="#position" id="icon"><img src="img/iconColor6.png" alt="Position icon"> Position in the Periodic
            Table</a> <!-- Position in the Periodic Table / item g-->
        <a href="#image" id="icon"><img src="img/iconColor7.png" alt="Image icon"> Image</a> <!-- Image / item h-->
        <a href="#electronic" id="icon"><img src="img/iconColor8.png" alt="Electronic icon"> Electronic
            Configuration</a> <!-- Electronic Configuration / item i-->
